...
class TensorUI:
    def __init__(self, parent):
        ...
        method_option = OptionMenu(self.myContainer1, var2, *self.selectedMethods,command=self.getSelectedMethod)
    ...
    def submitClick(self):
        if self.selectedScenario == self.scenarios[0]:
            ...
            value='3'
        Helios.Helios(value,self.file_path,self.methodsValue[self.selectedMethod], self.op.get())
